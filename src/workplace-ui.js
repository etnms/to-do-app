...
const createWorkplaceUi = (name) => {
    ...
    btnAddToDoWorkplace.addEventListener("click", () => {addFunctionsToButtons(event)});
...
export { displayWorkplaceList, removeFromListWorkPlace, clearDisplay, createWorkplaceUi, tmpBtnName };
